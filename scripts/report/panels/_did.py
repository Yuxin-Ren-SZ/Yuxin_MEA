...
DID_METHOD = (
    ...
    "each chip's treated minus its own Control value is that chip's DiD. Faint "
    "points = wells, bold points = the per-chip means, bar = mean of the chip "
    "means, whisker = 95% t-CI (df = n_chips − 1), dashed line = no change. "
